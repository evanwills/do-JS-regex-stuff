...
abstract class RegexAction implements IRegexAction
{
    ...
    /**
     * Get extra outputs generated by the action
     *
     * @return array,false Array of key/value pairs to be returned
     *         to the client or FALSE if nothing is to be returned
     */
    public function extraOutputs()
    {
        return false;
    }
